...
tabss.forEach((tab, index) => {
  ...
  //   const sectionTwo = document.querySelector('.section.impact-section');
  //   const oneHeight = sectionOne.offsetHeight;
  //   sectionTwo.style.marginTop = `-${oneHeight}px`;
  // });
...
// You must observe the correct element
// Example: If the element has the class 'video-frame-outer'
// const targetElement = document.querySelector('.video-frame-outer');
// if (targetElement) {
//     observer.observe(targetElement);
// }

//   const elements = document.querySelectorAll('.video-frame-outer');
//   elements.forEach(el => observer.observe(el));

// Hero-section gradient-text bounce and text switch
